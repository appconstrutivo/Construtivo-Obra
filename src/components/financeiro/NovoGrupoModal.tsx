...
import { insertGrupo } from '@/lib/supabase';

type NovoGrupoModalProps = {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
...
export default function NovoGrupoModal({
  ...
  // Log para debugging quando o componente é montado ou o estado isOpen muda
  useEffect(() => {
    console.log('Modal Novo Grupo - isOpen:', isOpen);
